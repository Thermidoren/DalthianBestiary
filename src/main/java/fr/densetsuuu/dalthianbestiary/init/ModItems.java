...
import fr.densetsuuu.dalthianbestiary.items.ItemBase;
import fr.densetsuuu.dalthianbestiary.items.armor.ArmorBase;
import fr.densetsuuu.dalthianbestiary.items.tools.Copper.*;
import fr.densetsuuu.dalthianbestiary.items.tools.Tin.*;
